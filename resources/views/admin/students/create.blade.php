...
@section('content')
    <div class="flex flex-wrap items-center justify-between gap-4">
        <h2 class="text-xl font-semibold uppercase">Register New Student</h2>
        ...
        <form action="{{ route('admin.students.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="passport_number" id="passport_number" class="form-input" required value="{{ old('passport_number') }}" />
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nationality" id="nationality" class="form-input" required value="{{ old('nationality') }}" />
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="country_of_origin" id="country_of_origin" class="form-input" required value="{{ old('country_of_origin') }}" />
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="institute_name" id="institute_name" class="form-input" value="{{ old('institute_name') }}" />
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="zip_code" id="zip_code" class="form-input" value="{{ old('zip_code') }}" />
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="country_code" id="country_code" class="form-input" value="{{ old('country_code') }}" />
