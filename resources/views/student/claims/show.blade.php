...
@section('content')
    <div class="max-w-4xl mx-auto">
        <div class="flex items-center justify-between mb-12">
            <h2 class="text-2xl font-bold text-[#4A3B75]">Claim Details</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-3xl p-8 shadow-2xl shadow-purple-50 border border-gray-50 space-y-8">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="text-sm font-bold text-[#4A3B75]">{{ $claim->claim_number }}</h3>
                ...
                <div class="space-y-6 pt-4">
                    <div class="grid grid-cols-2">
                        <span class="text-xs font-bold text-gray-500 uppercase tracking-widest">Claim Type</span>
                        <span class="text-xs font-medium text-[#4A3B75] uppercase">{{ $claim->claim_type }}</span>
                    </div>
                    <div class="grid grid-cols-2">
                    ...
                    <div class="grid grid-cols-2">
                        <span class="text-xs font-bold text-gray-500 uppercase tracking-widest">Amount</span>
                        <span class="text-xs font-medium text-gray-700">{{ $claim->currency }} {{ number_format($claim->amount, 2) }}</span>
                    </div>
                    <div class="grid grid-cols-2">
                        <span class="text-xs font-bold text-gray-500 uppercase tracking-widest">Policy</span>
            ...
            <div class="bg-white rounded-3xl p-8 shadow-2xl shadow-purple-50 border border-gray-50">
                <h4 class="text-xs font-bold text-gray-500 uppercase tracking-widest mb-8">Bank Details</h4>
                <div class="space-y-6">
                    <div>
                        <span class="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-1">Account Holder</span>
                    ...
                    <div>
                        <span class="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-1">IBAN</span>
                        <span class="text-xs font-medium text-gray-700">{{ $claim->iban }}</span>
                    </div>
                    <div>
                        <span class="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-1">BIC/SWIFT</span>
                        <span class="text-xs font-medium text-gray-700">{{ $claim->bic_swift }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="md:col-span-2 bg-white rounded-3xl p-8 shadow-2xl shadow-purple-50 border border-gray-50">
                <div class="flex items-center justify-between mb-8">
                    <h4 class="text-xs font-bold text-gray-500 uppercase tracking-widest">Attached Documents</h4>
                </div>
            ...
            @if($claim->admin_notes)
                ...
                <div class="md:col-span-2 bg-[#F9F8FF] rounded-3xl p-8 border border-purple-100">
                    <h4 class="text-xs font-bold text-purple-300 uppercase tracking-widest mb-4">Response from Admin</h4>
                    <p class="text-sm text-[#4A3B75] italic leading-relaxed">
                        "{{ $claim->admin_notes }}"
                    </p>
                    <div class="mt-4 flex items-center gap-2">
                        <div class="w-2 h-2 rounded-full bg-purple-400"></div>
                        <span class="text-xs font-bold text-purple-300 uppercase tracking-widest">
