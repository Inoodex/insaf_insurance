    ...
    <div class="mb-12">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div class="ml-auto flex flex-wrap bg-gray-50/50 p-1 rounded-2xl border border-gray-50 student-option-nav">
                <a href="{{ route('student.policies.show', $application->id) }}"
                    ...
                    <span class="text-[8px] font-bold uppercase tracking-widest">Details</span>
                </a>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-3xl p-8 shadow-2xl shadow-purple-50 border border-gray-80 flex flex-col gap-8">
                <h4 class="text-[10px] font-bold text-gray-600 uppercase tracking-[0.2em]">Policy</h4>
                <div class="space-y-6">
                    <div class="flex justify-between items-start">
                        <span class="text-[10px] font-bold text-gray-600 uppercase tracking-widest">Policy ID</span>
                        <span class="text-xs font-medium text-gray-700 text-right">{{ $application->policy_number }}</span>
                    </div>
                    <div class="flex justify-between items-start">
                        <span class="text-[10px] font-bold text-gray-600 uppercase tracking-widest min-w-[80px]">Insurance
                            Conditions</span>
                        <span
                            class="text-xs font-medium text-gray-700 text-right">{{ $application->gic_reference ?? 'ISIE-GIC-012026' }}</span>
                    </div>
                    <div class="flex justify-between items-start">
                        <span class="text-[10px] font-bold text-gray-600 uppercase tracking-widest">From</span>
                        <span
                            class="text-xs font-medium text-gray-700 text-right">{{ $application->start_date->format('d.m.Y') }}</span>
                    </div>
                    <div class="flex justify-between items-start">
                        <span class="text-[10px] font-bold text-gray-600 uppercase tracking-widest">End Date</span>
                        <span
                            class="text-xs font-medium text-gray-700 text-right">{{ $application->end_date->format('d.m.Y') }}</span>
                    </div>
                    <div class="flex justify-between items-start">
                        <span class="text-[10px] font-bold text-gray-600 uppercase tracking-widest">First Destination</span>
                        <span
                            class="text-xs font-medium text-gray-700 text-right">{{ $application->first_destination }}</span>
                    </div>
                    <div class="flex justify-between items-start">
                        <span class="text-[10px] font-bold text-gray-600 uppercase tracking-widest">Area of Cover</span>
                        <span
            ...
            <!-- Policy Holder Card -->
            <div class="bg-white rounded-3xl p-8 shadow-2xl shadow-purple-50 border border-gray-80 flex flex-col gap-8">
                <h4 class="text-[10px] font-bold text-gray-600 uppercase tracking-[0.2em]">Policy Holder</h4>
                <div class="space-y-6">
                    <div class="flex justify-between items-start">
                        <span class="text-[10px] font-bold text-gray-600 uppercase tracking-widest">Name</span>
                    ...
                    <div class="flex justify-between items-start">
                        <span class="text-[10px] font-bold text-gray-600 uppercase tracking-widest">Address</span>
                        <span
                    ...
                    <div class="flex justify-between items-start">
                        <span class="text-[10px] font-bold text-gray-600 uppercase tracking-widest">Zip Code</span>
                        <span class="text-xs font-medium text-gray-700 text-right">PLA 1501</span>
                    </div>
                    <div class="flex justify-between items-start">
                        <span class="text-[10px] font-bold text-gray-600 uppercase tracking-widest">City</span>
                        <span class="text-xs font-medium text-gray-700 text-right">Tarxien</span>
                    </div>
                    <div class="flex justify-between items-start">
                        <span class="text-[10px] font-bold text-gray-600 uppercase tracking-widest">Country</span>
                        <span
                            class="text-xs font-medium text-gray-700 uppercase text-right">{{ $application->student->nationality }}</span>
                    </div>
                    <div class="flex justify-between items-start">
                        <span class="text-[10px] font-bold text-gray-600 uppercase tracking-widest">Phone Number</span>
                        <span
                    ...
                    <div class="flex justify-between items-start border-t border-gray-80 pt-4">
                        <span class="text-[10px] font-bold text-gray-600 uppercase tracking-widest">Plan Level</span>
                        <span
            ...
            <!-- Insured Person Card -->
            <div class="bg-white rounded-3xl p-8 shadow-2xl shadow-purple-50 border border-gray-80 flex flex-col gap-8">
                <h4 class="text-[10px] font-bold text-gray-600 uppercase tracking-[0.2em]">Insured Person(s)</h4>
                <div
